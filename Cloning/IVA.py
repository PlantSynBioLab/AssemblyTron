...
#Now add DPNI for digestion
    ...
    for i, row in combinations.iterrows():
        ...
        right_pipette.aspirate(Input_values.loc[0].at['DPwater'], pcrplate[combinations.loc[i].at['pcrwell']], rate=2.0)
    ...
    for i, row in combinations.iterrows():
        ...
        left_pipette.aspirate(Input_values.loc[0].at['cutsmart'], pcrplate[combinations.loc[i].at['pcrwell']], rate=2.0)
    ...
    for i, row in combinations.iterrows():
        ...
        left_pipette.aspirate(Input_values.loc[0].at['DPNI'], pcrplate[combinations.loc[i].at['pcrwell']], rate=2.0)
        left_pipette.mix(3,Input_values.loc[0].at['DPwater']+Input_values.loc[0].at['cutsmart']+Input_values.loc[0].at['DPNI'],pcrplate[combinations.loc[i].at['pcrwell']])
        left_pipette.drop_tip()
