...
######################separate pcrrxns####################################
########################################################################
if Input_values.loc[0].at['Combinatorial_pcr_params'] == 'N':
    runnumber = 0
...
##########################################################################################################################
    ...
    for i in range(0:pcr_plustemplates['run'].sum())
...
#maybe use the median annealing temperature in the spreadsheet
        ...
        for j, row in pcr_plustemplates.iterrows():
            if pcr_plustemplates.loc[j,'run'] == i:
                right_pipette.pick_up_tip()
                right_pipette.aspirate(Input_values.loc[j].at['pcrvol'],pcrplate[pcr_plustemplates.loc[j].at['frag_pcr_tube']],2)
                right_pipette.dispense(Input_values.loc[j].at['pcrvol'],cold_tuberack[pcr_plustemplates.loc[j].at['holding_tube']],2)
                #right_pipette.blow_out()
                right_pipette.drop_tip()

    for i, row in pcr_plustemplates.iterrows():
        right_pipette.pick_up_tip()
        right_pipette.aspirate(Input_values.loc[j].at['pcrvol'],cold_tuberack[pcr_plustemplates.loc[i].at['frag_pcr_tube']],2)
        right_pipette.dispense(Input_values.loc[j].at['pcrvol'],pcrplate[pcr_plustemplates.loc[i].at['holding_tube']],2)
        right_pipette.blow_out()
        right_pipette.drop_tip()
