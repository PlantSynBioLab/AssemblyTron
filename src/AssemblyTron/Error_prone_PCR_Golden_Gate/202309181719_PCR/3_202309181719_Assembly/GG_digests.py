...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    left_pipette.aspirate(1.7461792316811382, secondarydils['E1']) 

    left_pipette.dispense(1.7461792316811382, pcrplate['B8']) 
    ...
    left_pipette.aspirate(2.881844380403458, secondarydils['D1']) 

    left_pipette.dispense(2.881844380403458, pcrplate['B8']) 
    ...
    left_pipette.aspirate(1.7013232514177692, secondarydils['H1']) 

    left_pipette.dispense(1.7013232514177692, pcrplate['B8']) 
    ...
    left_pipette.aspirate(1.9898517560441744, secondarydils['E2']) 

    left_pipette.dispense(1.9898517560441744, pcrplate['B8']) 
    ...
    left_pipette.aspirate(3.03, watertuberack['A1']) 

    left_pipette.dispense(3.03, pcrplate['B8']) 
    ...
    left_pipette.dispense(1.7461792316811382, pcrplate['B9']) 
    ...
    left_pipette.dispense(2.881844380403458, pcrplate['B9']) 
    ...
    left_pipette.aspirate(1.7013232514177692, secondarydils['B1']) 

    left_pipette.dispense(1.7013232514177692, pcrplate['B9']) 
    ...
    left_pipette.dispense(1.9898517560441744, pcrplate['B9']) 
    ...
    left_pipette.dispense(3.03, pcrplate['B9']) 
