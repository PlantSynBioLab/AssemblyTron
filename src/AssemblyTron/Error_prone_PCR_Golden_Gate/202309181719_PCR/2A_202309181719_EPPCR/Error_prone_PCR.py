...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    right_pipette.dispense(33.58, pcrplate['H1'], rate=2.0) 
    ...
    left_pipette.dispense(1.2, pcrplate['H1'], rate=2.0) 
    ...
    left_pipette.dispense(1, pcrplate['H1'], rate=2.0) 
    ...
    left_pipette.dispense(3.6, pcrplate['H1'], rate=2.0) 
    ...
    left_pipette.dispense(2.5, pcrplate['H1'], rate=2.0) 
    ...
    right_pipette.aspirate(13.12, cold_tuberack['D3'], rate=2.0) 

    right_pipette.dispense(13.12, pcrplate['H1'], rate=2.0) 
    ...
    right_pipette.mix(3,33.58,pcrplate['H1']) 
