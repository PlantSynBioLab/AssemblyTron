...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    right_pipette.aspirate(volume = 9.257352941176473, location = watertuberack['A1'], rate=1.0) 

    right_pipette.dispense(9.257352941176473, tuberack2['B5'], rate=1.0) 
    ...
    right_pipette.mix(3,9.257352941176473,tuberack2['B5']) 
