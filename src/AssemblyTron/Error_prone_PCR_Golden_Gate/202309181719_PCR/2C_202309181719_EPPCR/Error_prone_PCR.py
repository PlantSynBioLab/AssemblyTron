...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    right_pipette.aspirate(34.15, watertuberack['A1'], rate=2.0) 

    right_pipette.dispense(34.15, pcrplate['H1'], rate=2.0) 
    ...
    right_pipette.aspirate(20, cold_tuberack['C3'], rate=2.0) 

    right_pipette.dispense(20, pcrplate['H1'], rate=2.0) 
    ...
    left_pipette.aspirate(3.5, cold_tuberack['C4'], rate=2.0) 

    left_pipette.dispense(3.5, pcrplate['H1'], rate=2.0) 
    ...
    left_pipette.aspirate(4, cold_tuberack['C5'], rate=2.0) 

    left_pipette.dispense(4, pcrplate['H1'], rate=2.0) 
    ...
    left_pipette.aspirate(2, cold_tuberack['C6'], rate=2.0) 
    ...
    left_pipette.aspirate(1.35, cold_tuberack['D1'], rate=2.0) 

    left_pipette.dispense(1.35, pcrplate['H1'], rate=2.0) 
    ...
    left_pipette.aspirate(10, cold_tuberack['D3'], rate=2.0) 
    ...
    right_pipette.mix(3,34.15,pcrplate['H1']) 
    ...
    right_pipette.aspirate(13.28, cold_tuberack['D3'], rate=2.0) 

    right_pipette.dispense(13.28, pcrplate['H1'], rate=2.0) 
