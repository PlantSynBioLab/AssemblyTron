...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(30.9163294117647, watertuberack['A1']) 
    right_pipette.dispense(30.9163294117647, secondarydils['B1']) 
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.mix(3,7.729082352941175,secondarydils['B1']) 
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    ...
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(11.63313807531381, watertuberack['A1']) 
    right_pipette.dispense(11.63313807531381, secondarydils['B2']) 
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.mix(3,3.8777126917712694,secondarydils['B2']) 
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(27.21718518518518, watertuberack['A1']) 
    right_pipette.dispense(27.21718518518518, secondarydils['D1']) 
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(4, pcrplate['D1']) 
    left_pipette.dispense(4, secondarydils['D1']) 
    left_pipette.mix(3,3,secondarydils['D1']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.mix(3,6.804296296296295,secondarydils['D1']) 
    left_pipette.drop_tip() 
    protocol.pause('Clear off PCR plate and set up final Golden Gate assembly Tubes') 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1.818181818181818, secondarydils['E11']) 
    left_pipette.dispense(1.818181818181818, pcrplate['B8']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(2.548074590415811, secondarydils['C1']) 
    left_pipette.dispense(2.548074590415811, pcrplate['B8']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(3.979999999999999, watertuberack['A1']) 
    left_pipette.dispense(3.979999999999999, pcrplate['B8']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(9.090909090909092, secondarydils['F11']) 
    left_pipette.dispense(9.090909090909092, pcrplate['B9']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(-2.7399999999999998, watertuberack['A1']) 
    left_pipette.dispense(-2.7399999999999998, pcrplate['B9']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1.65,cold_tuberack['C4']) 
