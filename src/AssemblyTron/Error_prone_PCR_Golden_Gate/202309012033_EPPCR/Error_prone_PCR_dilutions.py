...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    right_pipette.aspirate(volume = 3.0661764705882355, location = watertuberack['A1'], rate=1.0) 
    right_pipette.dispense(3.0661764705882355, tuberack2['B3'], rate=1.0) 
    right_pipette.aspirate(volume = 1.1360294117647065, location = watertuberack['A1'], rate=1.0) 
    right_pipette.dispense(1.1360294117647065, tuberack2['B4'], rate=1.0) 
    ...
    left_pipette.aspirate(3.0, cold_tuberack['B3'], rate=1.0) 
    left_pipette.dispense(3.0, tuberack2['B3'], rate=1.0) 
    left_pipette.mix(3,5,tuberack2['B3']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(3.0, cold_tuberack['B4'], rate=1.0) 
    left_pipette.dispense(3.0, tuberack2['B4'], rate=1.0) 
    ...
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,3.0661764705882355,tuberack2['B3']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,1.1360294117647065,tuberack2['B4']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
