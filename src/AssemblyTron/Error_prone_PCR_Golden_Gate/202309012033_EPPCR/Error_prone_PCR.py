...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    right_pipette.dispense(33.58, pcrplate['A3'], rate=2.0) 
    right_pipette.blow_out() 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(33.58, watertuberack['A1'], rate=2.0) 
    right_pipette.dispense(33.58, pcrplate['A5'], rate=2.0) 
    right_pipette.blow_out() 
    right_pipette.drop_tip() 
    ...
    left_pipette.dispense(20, pcrplate['A3'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(20, cold_tuberack['C3'], rate=2.0) 
    left_pipette.dispense(20, pcrplate['A5'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.dispense(13.12, pcrplate['A3'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(13.12, cold_tuberack['D3'], rate=2.0) 
    left_pipette.dispense(13.12, pcrplate['A5'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1, cold_tuberack['C1'], rate=2.0) 
    left_pipette.aspirate(1, pcrplate['A3'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1, cold_tuberack['C1'], rate=2.0) 
    left_pipette.aspirate(1, pcrplate['A5'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,33.58,pcrplate['A3']) 
    right_pipette.blow_out() 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,33.58,pcrplate['A5']) 
    right_pipette.blow_out() 
    right_pipette.drop_tip() 
    tc_mod.close_lid() 
