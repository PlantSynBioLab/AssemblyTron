...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(13.019435294117647, watertuberack['A1']) 
    right_pipette.dispense(13.019435294117647, secondarydils['B1']) 
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,13.019435294117647,secondarydils['B1']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    ...
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(24.319888423988843, watertuberack['A1']) 
    right_pipette.dispense(24.319888423988843, secondarydils['B2']) 
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.mix(3,6.079972105997211,secondarydils['B2']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(8.696246913580245, watertuberack['A1']) 
    left_pipette.dispense(8.696246913580245, secondarydils['D1']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.mix(3,8.696246913580245,secondarydils['D1']) 
    left_pipette.drop_tip() 
    protocol.pause('Clear off PCR plate and set up final Golden Gate assembly Tubes') 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(9.090909090909092, secondarydils['E11']) 
    left_pipette.dispense(9.090909090909092, pcrplate['B8']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1.0576913394178835, secondarydils['C1']) 
    left_pipette.dispense(1.0576913394178835, pcrplate['B8']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(-1.8000000000000003, watertuberack['A1']) 
    left_pipette.dispense(-1.8000000000000003, pcrplate['B8']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
