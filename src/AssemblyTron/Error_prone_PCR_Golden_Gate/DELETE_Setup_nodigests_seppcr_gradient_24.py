...
if __name__ == '__main__':
    ...
    for i, row in GG_dfs.iterrows():
        ...
        def set_variables():
            ...
            if len(pandas.unique(locals()[x]['frag_loc'])) == 1:
                global temppwl1
                global conc1

            if len(pandas.unique(locals()[x]['frag_loc'])) == 2:
                global temppwl1
                global temppwl2
                global conc1
                global conc2
            
            if len(pandas.unique(locals()[x]['frag_loc'])) == 3:
                global temppwl1
                global temppwl2
                global temppwl3
                global conc1
            ...
            if len(pandas.unique(locals()[x]['frag_loc'])) == 4:
                global temppwl1
                global temppwl2
                global temppwl3
                global temppwl4
            ...
            if len(pandas.unique(locals()[x]['frag_loc'])) == 5:
                global temppwl1
                global temppwl2
                global temppwl3
                global temppwl4
            ...
            if len(pandas.unique(locals()[x]['frag_loc'])) == 6:
                global temppwl1
                global temppwl2
                global temppwl3
                global temppwl4
        ...
        for i, row in locals()[x].iterrows():
            ...
            label_extra1 = tk.Label(text=locals()[x].loc[i].at['frag_loc'],font=('Helvatical bold',14))
            label_extra1.place(relx = 0.3, rely = rel_y)
        ...
        locals()[x]['conc_assumed'] = tempconcs
