...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    right_pipette.dispense(101.0, tuberack2['B3'], rate=1.0) 
    right_pipette.aspirate(volume = 125.8, location = watertuberack['A1'], rate=1.0) 
    right_pipette.dispense(125.8, tuberack2['B4'], rate=1.0) 
    right_pipette.aspirate(volume = 107.6, location = watertuberack['A1'], rate=1.0) 
    right_pipette.dispense(107.6, tuberack2['B5'], rate=1.0) 
    right_pipette.aspirate(volume = 107.6, location = watertuberack['A1'], rate=1.0) 
    right_pipette.dispense(107.6, tuberack2['B6'], rate=1.0) 
    ...
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,101.0,tuberack2['B3']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,125.8,tuberack2['B4']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,107.6,tuberack2['B5']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,107.6,tuberack2['B6']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
