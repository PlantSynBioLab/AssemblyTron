...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    right_pipette.aspirate(volume = 18.577205882352946, location = watertuberack['A1'], rate=1.0) 
    right_pipette.dispense(18.577205882352946, tuberack2['A5'], rate=1.0) 
    right_pipette.aspirate(volume = -3.0, location = watertuberack['A1'], rate=1.0) 
    right_pipette.dispense(-3.0, tuberack2['A6'], rate=1.0) 
    ...
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(3.0, cold_tuberack['A6'], rate=1.0) 
    left_pipette.dispense(3.0, tuberack2['A6'], rate=1.0) 
    ...
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,18.577205882352946,tuberack2['A5']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,-3.0,tuberack2['A6']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
