...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(10.903294117647055, watertuberack['A1']) 
    right_pipette.dispense(10.903294117647055, secondarydils['C1']) 
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,10.903294117647055,secondarydils['C1']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    ...
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(26.060251046025108, watertuberack['A1']) 
    right_pipette.dispense(26.060251046025108, secondarydils['C2']) 
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(6, pcrplate['C2']) 
    left_pipette.dispense(6, secondarydils['C2']) 
    left_pipette.mix(3,3,secondarydils['C2']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.mix(3,8.686750348675035,secondarydils['C2']) 
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(29.109135802469133, watertuberack['A1']) 
    right_pipette.dispense(29.109135802469133, secondarydils['E1']) 
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(4, pcrplate['E1']) 
    left_pipette.dispense(4, secondarydils['E1']) 
    left_pipette.mix(3,3,secondarydils['E1']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.mix(3,7.277283950617283,secondarydils['E1']) 
    left_pipette.drop_tip() 
    protocol.pause('Clear off PCR plate and set up final Golden Gate assembly Tubes') 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(2.857142857142857, secondarydils['E11']) 
    left_pipette.dispense(2.857142857142857, pcrplate['B8']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1.401441024728696, secondarydils['D1']) 
    left_pipette.dispense(1.401441024728696, pcrplate['B8']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(4.09, watertuberack['A1']) 
    left_pipette.dispense(4.09, pcrplate['B8']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(2.2222222222222223, secondarydils['F11']) 
    left_pipette.dispense(2.2222222222222223, pcrplate['B9']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(4.130000000000001, watertuberack['A1']) 
    left_pipette.dispense(4.130000000000001, pcrplate['B9']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1.65,cold_tuberack['C4']) 
