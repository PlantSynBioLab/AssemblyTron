...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    right_pipette.aspirate(volume = 10.200000000000001, location = watertuberack['A1'], rate=1.0) 
    right_pipette.dispense(10.200000000000001, tuberack2['B5'], rate=1.0) 
    right_pipette.aspirate(volume = 10.200000000000001, location = watertuberack['A1'], rate=1.0) 
    right_pipette.dispense(10.200000000000001, tuberack2['B6'], rate=1.0) 
    ...
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(3.0, cold_tuberack['B6'], rate=1.0) 
    left_pipette.dispense(3.0, tuberack2['B6'], rate=1.0) 
    ...
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,10.200000000000001,tuberack2['B5']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,10.200000000000001,tuberack2['B6']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
