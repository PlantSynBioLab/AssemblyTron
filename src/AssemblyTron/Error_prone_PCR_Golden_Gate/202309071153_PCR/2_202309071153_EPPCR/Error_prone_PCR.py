...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    right_pipette.dispense(33.58, pcrplate['B1'], rate=2.0) 
    right_pipette.blow_out() 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(33.58, watertuberack['A1'], rate=2.0) 
    right_pipette.dispense(33.58, pcrplate['D1'], rate=2.0) 
    right_pipette.blow_out() 
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(4.0, tuberack2['A3'], rate=2.0) 
    left_pipette.dispense(4.0, pcrplate['B1'], rate=2.0) 
    ...
    left_pipette.dispense(4.0, pcrplate['D1'], rate=2.0) 
    ...
    left_pipette.dispense(20, pcrplate['B1'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(20, cold_tuberack['C3'], rate=2.0) 
    left_pipette.dispense(20, pcrplate['D1'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1.2, cold_tuberack['C4'], rate=2.0) 
    left_pipette.dispense(1.2, pcrplate['B1'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1.2, cold_tuberack['C4'], rate=2.0) 
    left_pipette.dispense(1.2, pcrplate['D1'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1, cold_tuberack['C5'], rate=2.0) 
    left_pipette.dispense(1, pcrplate['B1'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1, cold_tuberack['C5'], rate=2.0) 
    left_pipette.dispense(1, pcrplate['D1'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(3.6, cold_tuberack['C6'], rate=2.0) 
    left_pipette.dispense(3.6, pcrplate['B1'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(3.6, cold_tuberack['C6'], rate=2.0) 
    left_pipette.dispense(3.6, pcrplate['D1'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(2.5, cold_tuberack['D1'], rate=2.0) 
    left_pipette.dispense(2.5, pcrplate['B1'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(2.5, cold_tuberack['D1'], rate=2.0) 
    left_pipette.dispense(2.5, pcrplate['D1'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(10, cold_tuberack['D2'], rate=2.0) 
    left_pipette.dispense(10, pcrplate['B1'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(10, cold_tuberack['D2'], rate=2.0) 
    left_pipette.dispense(10, pcrplate['D1'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(13.12, cold_tuberack['D3'], rate=2.0) 
    left_pipette.dispense(13.12, pcrplate['B1'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(13.12, cold_tuberack['D3'], rate=2.0) 
    left_pipette.dispense(13.12, pcrplate['D1'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1, cold_tuberack['C1'], rate=2.0) 
    left_pipette.aspirate(1, pcrplate['B1'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1, cold_tuberack['C1'], rate=2.0) 
    left_pipette.aspirate(1, pcrplate['D1'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,33.58,pcrplate['B1']) 
    right_pipette.blow_out() 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,33.58,pcrplate['D1']) 
    right_pipette.blow_out() 
    right_pipette.drop_tip() 
    tc_mod.close_lid() 
