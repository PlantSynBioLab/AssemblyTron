...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    right_pipette.dispense(31.271152941176467, secondarydils['D1']) 
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,31.271152941176467,secondarydils['D1']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    ...
    right_pipette.dispense(27.312178521617852, secondarydils['D2']) 
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(4, pcrplate['D2']) 
    left_pipette.dispense(4, secondarydils['D2']) 
    left_pipette.mix(3,3,secondarydils['D2']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.mix(3,6.828044630404463,secondarydils['D2']) 
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(26.764375308641974, watertuberack['A1']) 
    right_pipette.dispense(26.764375308641974, secondarydils['F1']) 
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,26.764375308641974,secondarydils['F1']) 
    right_pipette.drop_tip() 
    protocol.pause('Clear off PCR plate and set up final Golden Gate assembly Tubes') 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(3.1999999999999997, watertuberack['A1']) 
    left_pipette.dispense(3.1999999999999997, pcrplate['B8']) 
    ...
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(3.1493056735476315, secondarydils['E1']) 
    ...
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(2.8699999999999997, watertuberack['A1']) 
    left_pipette.dispense(2.8699999999999997, pcrplate['B9']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(2.0, secondarydils['D2']) 
