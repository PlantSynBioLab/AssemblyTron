...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    right_pipette.aspirate(volume = 309.0, location = watertuberack['A1'], rate=1.0) 
    right_pipette.dispense(309.0, tuberack2['B5'], rate=1.0) 
    right_pipette.aspirate(volume = 299.0, location = watertuberack['A1'], rate=1.0) 
    right_pipette.dispense(299.0, tuberack2['B6'], rate=1.0) 
    right_pipette.aspirate(volume = 289.0, location = watertuberack['A1'], rate=1.0) 
    right_pipette.dispense(289.0, tuberack2['C1'], rate=1.0) 
    right_pipette.aspirate(volume = 279.0, location = watertuberack['A1'], rate=1.0) 
    right_pipette.dispense(279.0, tuberack2['C2'], rate=1.0) 
    ...
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,309.0,tuberack2['B5']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,299.0,tuberack2['B6']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,289.0,tuberack2['C1']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,279.0,tuberack2['C2']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
