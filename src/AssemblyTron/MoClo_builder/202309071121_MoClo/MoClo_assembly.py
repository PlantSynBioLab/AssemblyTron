...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1, moclo_plate['A8']) 
    left_pipette.dispense(1, pcrplate['B2']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1, moclo_plate['A12']) 
    left_pipette.dispense(1, pcrplate['B2']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1, moclo_plate['B11']) 
    left_pipette.dispense(1, pcrplate['B2']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(7, watertuberack['A1']) 
    left_pipette.dispense(7, pcrplate['B3']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(2,cold_tuberack['C4']) 
    ...
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1, moclo_plate['C5']) 
    left_pipette.dispense(1, pcrplate['B3']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1, moclo_plate['C7']) 
    left_pipette.dispense(1, pcrplate['B3']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1, moclo_plate['B4']) 
    left_pipette.dispense(1, pcrplate['B3']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1, moclo_plate['B12']) 
    left_pipette.dispense(1, pcrplate['B3']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(7, watertuberack['A1']) 
    left_pipette.dispense(7, pcrplate['B4']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(2,cold_tuberack['C4']) 
    left_pipette.dispense(2,pcrplate['B4']) 
    left_pipette.mix(3,8,pcrplate['B4']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1, moclo_plate['A1']) 
    left_pipette.dispense(1, pcrplate['B4']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1, moclo_plate['A8']) 
    ...
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1, moclo_plate['C9']) 
    left_pipette.dispense(1, pcrplate['B4']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1, moclo_plate['C10']) 
    left_pipette.dispense(1, pcrplate['B4']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.aspirate(1,cold_tuberack['D5']) 
    left_pipette.dispense(1,pcrplate['B4']) 
    left_pipette.mix(3,9,pcrplate['B4']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1,cold_tuberack['C5']) 
    left_pipette.dispense(1,pcrplate['B4']) 
    ...
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,15,pcrplate['B4']) 
    right_pipette.blow_out() 
    right_pipette.drop_tip() 
    tc_mod.close_lid() 
