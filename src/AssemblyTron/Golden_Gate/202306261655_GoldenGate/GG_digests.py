...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    protocol.pause('move to gradient thermocycler. set gradiet to be between 66.45888103179655 and 70.2514421103834. Extension time should be 2    94.62
Name: Length, dtype: float64 seconds. Follow normal parameters for everything else. A1 is cool, A8 is hot.') 
    temp_module.set_temperature(4) 
