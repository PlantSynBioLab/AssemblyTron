...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    left_pipette.dispense(0.75, pcrplate['A5'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(0.75, tuberack2['D6'], rate=2.0) 
    left_pipette.dispense(0.75, pcrplate['B5'], rate=2.0) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(12.5, cold_tuberack['D6'], rate=2.0) 
    right_pipette.aspirate(12.5, pcrplate['A5'], rate=2.0) 
    right_pipette.blow_out() 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(12.5, cold_tuberack['D6'], rate=2.0) 
    right_pipette.aspirate(12.5, pcrplate['B5'], rate=2.0) 
    right_pipette.blow_out() 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    ...
    protocol.pause('move to gradient thermocycler. set gradiet to be between 50.66281635545529 and 75.9681841688045. Extension time should be 106.17 seconds. Follow normal parameters for everything else. A1 is cool, A8 is hot.') 
    temp_module.set_temperature(4) 
    ...
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(40.192893401015226,watertuberack['A1'],2) 
    right_pipette.dispense(40.192893401015226,pcrplate['E11'],2) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(38.98327759197324,watertuberack['A1'],2) 
    right_pipette.dispense(38.98327759197324,pcrplate['F11'],2) 
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(3.807106598984771,tuberack2['A5'],2) 
    left_pipette.dispense(3.807106598984771,pcrplate['E11'],2) 
    left_pipette.mix(3,3.807106598984771,pcrplate['E11']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(5.016722408026756,tuberack2['A6'],2) 
    left_pipette.dispense(5.016722408026756,pcrplate['F11'],2) 
    left_pipette.mix(3,5.016722408026756,pcrplate['F11']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(20, pcrplate['A5']) 
    right_pipette.dispense(20, secondarydils['A5']) 
    right_pipette.blow_out() 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    ...
    right_pipette.dispense(25.779539170506908, secondarydils['B5']) 
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(6, pcrplate['B5']) 
    left_pipette.dispense(6, secondarydils['B5']) 
    left_pipette.mix(3,3,secondarydils['B5']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.mix(3,8.593179723502303,secondarydils['B5']) 
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    ...
    right_pipette.dispense(25.6468202764977, secondarydils['B5']) 
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(6, pcrplate['B5']) 
    left_pipette.dispense(6, secondarydils['B5']) 
    ...
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.mix(3,8.5489400921659,secondarydils['B5']) 
    left_pipette.drop_tip() 
    protocol.pause('Clear off PCR plate and set up final Golden Gate assembly Tubes') 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(8.629999999999999, watertuberack['A1']) 
    left_pipette.dispense(8.629999999999999, pcrplate['B8']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1.0493387890648165, secondarydils['A5']) 
    ...
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(8.629999999999999, watertuberack['A1']) 
    left_pipette.dispense(8.629999999999999, pcrplate['B9']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(8.629999999999999, watertuberack['A1']) 
    left_pipette.dispense(8.629999999999999, pcrplate['B10']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(7.68, watertuberack['A1']) 
    left_pipette.dispense(7.68, pcrplate['B11']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(2.0, secondarydils['B5']) 
    ...
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(7.68, watertuberack['A1']) 
    left_pipette.dispense(7.68, pcrplate['C2']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(7.68, watertuberack['A1']) 
    left_pipette.dispense(7.68, pcrplate['C3']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
