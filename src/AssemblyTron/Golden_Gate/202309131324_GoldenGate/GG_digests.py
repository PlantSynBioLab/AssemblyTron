...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(2, cold_tuberack['D3'], rate=2.0) 
    left_pipette.dispense(2, pcrplate['B1'], rate=2.0) 
    left_pipette.mix(3,10,pcrplate['B1']) 
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    ...
    temp_module.set_temperature(4) 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(42.0,watertuberack['A1'],2) 
    right_pipette.dispense(42.0,pcrplate['E11'],2) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(43.84615384615385,watertuberack['A1'],2) 
    right_pipette.dispense(43.84615384615385,pcrplate['F11'],2) 
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(8.0,tuberack2['A5'],2) 
    left_pipette.dispense(8.0,pcrplate['E11'],2) 
    left_pipette.mix(3,8.0,pcrplate['E11']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(6.153846153846154,tuberack2['A6'],2) 
    left_pipette.dispense(6.153846153846154,pcrplate['F11'],2) 
    left_pipette.mix(3,6.153846153846154,pcrplate['F11']) 
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    ...
    right_pipette.dispense(6.815452818239392, secondarydils['H1']) 
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(6, pcrplate['H1']) 
    left_pipette.dispense(6, secondarydils['H1']) 
    left_pipette.mix(3,3,secondarydils['H1']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.mix(3,2.2718176060797974,secondarydils['H1']) 
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(20, pcrplate['E11']) 
    right_pipette.dispense(20, secondarydils['E11']) 
    ...
    right_pipette.dispense(18.438616714697403, secondarydils['B1']) 
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,18.438616714697403,secondarydils['B1']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    ...
    right_pipette.dispense(15.561383285302592, secondarydils['B1']) 
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1, pcrplate['B1']) 
    left_pipette.dispense(1, secondarydils['B1']) 
    ...
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,15.561383285302592,secondarydils['B1']) 
    right_pipette.drop_tip() 
    ...
    left_pipette.dispense(7.68, pcrplate['B8']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(7.68, watertuberack['A1']) 
    left_pipette.dispense(7.68, pcrplate['B9']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1.65,cold_tuberack['C4']) 
    ...
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(7.68, watertuberack['A1']) 
    left_pipette.dispense(7.68, pcrplate['B10']) 
    left_pipette.blow_out() 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1.65,cold_tuberack['C4']) 
