...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    # right_pipette.dispense(18, pcrplate['F1'], rate=2.0) 
    ...
    # left_pipette.dispense(5, pcrplate['F1'], rate=2.0) 

    # left_pipette.mix(3,10,pcrplate['F1']) 
    ...
    # left_pipette.dispense(2, pcrplate['F1'], rate=2.0) 
    ...
    # right_pipette.mix(3,35.5,pcrplate['F1']) 
    ...
    # left_pipette.aspirate(3.498542274052478,tuberack2['A5'],2) 
    ...
    # left_pipette.aspirate(3.821656050955414,tuberack2['A6'],2) 
