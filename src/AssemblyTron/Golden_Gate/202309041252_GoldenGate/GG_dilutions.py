...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    right_pipette.aspirate(volume = 10.6, location = watertuberack['A1'], rate=1.0) 
    right_pipette.dispense(10.6, tuberack2['B1'], rate=1.0) 
    right_pipette.aspirate(volume = 13.0, location = watertuberack['A1'], rate=1.0) 
    right_pipette.dispense(13.0, tuberack2['B2'], rate=1.0) 
    ...
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,10.6,tuberack2['B1']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,13.0,tuberack2['B2']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
