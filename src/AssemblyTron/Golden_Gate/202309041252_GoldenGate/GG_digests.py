...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    temp_module.set_temperature(4) 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(40.0,watertuberack['A1'],2) 
    right_pipette.dispense(40.0,pcrplate['E11'],2) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(41.11111111111112,watertuberack['A1'],2) 
    right_pipette.dispense(41.11111111111112,pcrplate['F11'],2) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(10.0,tuberack2['A5'],2) 
    right_pipette.dispense(10.0,pcrplate['E11'],2) 
    right_pipette.mix(3,10.0,pcrplate['E11']) 
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(8.88888888888889,tuberack2['A6'],2) 
    left_pipette.dispense(8.88888888888889,pcrplate['F11'],2) 
    left_pipette.mix(3,8.88888888888889,pcrplate['F11']) 
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    ...
    right_pipette.dispense(18.438616714697403, secondarydils['E1']) 
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    ...
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,18.438616714697403,secondarydils['E1']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    ...
    right_pipette.dispense(15.561383285302592, secondarydils['E1']) 
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1, pcrplate['E1']) 
    left_pipette.dispense(1, secondarydils['E1']) 
    ...
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,15.561383285302592,secondarydils['E1']) 
    right_pipette.drop_tip() 
