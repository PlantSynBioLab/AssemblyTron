...
############adding h20
                ...
                if globals()[x].loc[i].at['H20 to add to 1uL of fragment'] < 5:
                    right_pipette.pick_up_tip()
                    right_pipette.aspirate(5*(globals()[x].loc[i].at['H20 to add to 1uL of fragment']), watertuberack['A1'])
                    right_pipette.dispense(5*(globals()[x].loc[i].at['H20 to add to 1uL of fragment']), pcrplate[globals()[x].loc[i].at['dil_tube']])
                    #right_pipette.blow_out()
                    right_pipette.drop_tip()
#####################################################################################################
############adding temp
                ...
                if globals()[x].loc[i].at['H20 to add to 1uL of fragment'] < 5:
                    left_pipette.pick_up_tip()
                    left_pipette.aspirate(5, pcrplate[globals()[x].loc[i].at['frag_loc']])
                    left_pipette.dispense(5, pcrplate[globals()[x].loc[i].at['dil_tube']])
                    left_pipette.mix(3,3,pcrplate[globals()[x].loc[i].at['dil_tube']])
                    #left_pipette.blow_out()
                    left_pipette.drop_tip()
