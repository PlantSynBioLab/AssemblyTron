...
path = 'C:/Users/Public/Public Documents/opentrons/j5_Files/j5__pGP8A-ARF7 domain delete/oligo.feather'
...
#The user has to come down here and enter in a vector of the template concentrations **In the correct order of the the unique_templates dataframe** the 
# code will then automatically populate the pcr dataframe with this information
